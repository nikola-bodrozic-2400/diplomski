...
// die($role->getCanReadWrite()." ". $role->getCanRead());
            ...
            $privr = $value['security']['access_control'][5]['roles'];
            array_push($privr, $un);
            $value['security']['access_control'][5]['roles']  = $privr;

            $privr = $value['security']['access_control'][6]['roles'];
            array_push($privr, $un);
            $value['security']['access_control'][6]['roles']  = $privr;
